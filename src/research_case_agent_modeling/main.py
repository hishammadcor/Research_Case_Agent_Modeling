...
for persona_data in personas:
    ...
    persona = persona_data['Persona Prompt']
    ...
    run_file_name = f"{responses_file_dir}{persona_name}_{num_runs}_LLM_Output.json"
...
# Example: Evaluating results for one of the personas
for persona_data in personas:
    persona_name = persona_data['Persona Name']
    model_file = f'data/3_responces/{persona_name}_{num_runs}_LLM_Output.json'
    ...
    print(f"Evaluation for {persona_name}:")
